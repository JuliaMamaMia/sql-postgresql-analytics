...
## Что улучшить дальше (план)
- добавить `EXPLAIN ANALYZE` для 1–2 запросов и заметки по оптимизации
- добавить схему данных (ERD) в `docs/` и скриншоты результатов в `figures/`
